...
const items = [
  ...
  { icon: TrendingUp, label: 'Transações', href: '/dashboard/transactions', category: 'Financeiro' },
  { icon: Wallet, label: 'Pagamentos', href: '/dashboard/payments', category: 'Financeiro' },
  { icon: Users, label: 'Usuários', href: '/dashboard/users', category: 'Clientes' },
  { icon: UserCheck, label: 'Afiliados', href: '/dashboard/affiliates', category: 'Clientes' },
  { icon: Bot, label: 'Bots', href: '/bots', category: 'Sistema' },
  { icon: ShoppingCart, label: 'Produtos', href: '/products', category: 'Sistema' },
  { icon: GitBranch, label: 'Fluxos', href: '/flows', category: 'Sistema' },
  { icon: BarChart3, label: 'Analytics', href: '/analytics', category: 'Sistema' },
  { icon: Plug, label: 'Integrações', href: '/integrations', category: 'Configurações' },
  { icon: Settings, label: 'Configurações', href: '/settings', category: 'Configurações' },
]
