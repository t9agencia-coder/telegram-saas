...
const breadcrumbMap: Record<string, { label: string; parent?: string; group?: string }> = {
  ...
  '/dashboard/marketing/visao-geral': { label: 'Visão geral', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/campanhas': { label: 'Campanhas', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/conjuntos': { label: 'Conjuntos', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/anuncios': { label: 'Anúncios', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/conversoes': { label: 'Conversões', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/vendas': { label: 'Vendas', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/rastreamento': { label: 'Rastreamento', group: 'Marketing', parent: '/dashboard' },
  '/dashboard/marketing/integracoes': { label: 'Integrações', group: 'Marketing', parent: '/dashboard' },
