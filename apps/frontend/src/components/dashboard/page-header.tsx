...
const breadcrumbMap: Record<string, { label: string; parent?: string; group?: string }> = {
  ...
  '/dashboard/tracking/visao-geral': { label: 'Visão geral', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/campanhas': { label: 'Campanhas', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/integracoes': { label: 'Integrações', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/taxas': { label: 'Taxas', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/vendas': { label: 'Vendas', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/conversoes': { label: 'Conversões', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/conjuntos': { label: 'Conjuntos', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/anuncios': { label: 'Anúncios', group: 'Tracking', parent: '/dashboard' },
  '/dashboard/tracking/rastreamento': { label: 'Rastreamento', group: 'Tracking', parent: '/dashboard' },
