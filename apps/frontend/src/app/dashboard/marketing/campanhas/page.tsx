...
export default function MarketingCampaignsPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    api.get(`/workspaces/${workspaceId}/marketing/campaigns?${periodQuery(period)}`)
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="rounded-[4px] border border-white/[0.06] bg-[#141414] p-8 text-center">
          ...
          <Link href="/dashboard/marketing/integracoes" className="mt-3 inline-block text-sm text-[#E50914] hover:underline">Conectar Facebook Ads →</Link>
        </div>
      ) : (
